...
struct L {
    ...
    static func detect() -> L {
        ...
        default:   return L(heading:"Claude Code — Usage Limits",session:"Session (5h)",weekly:"Weekly (all)",weeklySonnet:"Weekly (Sonnet)",resets:"↻",updated:"Updated",refresh:"Refresh",close:"Close",noData:"No usage data yet",noDataSub:"Send a message in Claude Code",stale:" (stale)",statusHeading:"Claude System Status",operational:"Online",degraded:"Issues",outage:"Down",alertsToggle:"Incident Alerts",statusLoading:"Fetching status...")
        }
    }
}
